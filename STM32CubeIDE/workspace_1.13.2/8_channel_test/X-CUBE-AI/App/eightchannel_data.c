...
ai_buffer g_eightchannel_data_map_activations[AI_EIGHTCHANNEL_DATA_ACTIVATIONS_COUNT] = {
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 504, 1, 1),
    504, NULL, NULL),    /* heap_overlay_pool */
  };
ai_buffer g_eightchannel_data_map_weights[AI_EIGHTCHANNEL_DATA_WEIGHTS_COUNT] = {
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 436, 1, 1),
    436, NULL, s_eightchannel_weights_array_u64),   /* weights_array */
  };


/*!
 * @brief Get network activations buffer initialized struct.
 * @ingroup eightchannel_data
 ...
 */
AI_API_ENTRY
ai_bool ai_eightchannel_data_params_get(ai_network_params* params)
{
  if (!params) return false;
  
  const ai_buffer_array map_activations = 
    AI_BUFFER_ARRAY_OBJ_INIT(AI_FLAG_NONE, AI_EIGHTCHANNEL_DATA_ACTIVATIONS_COUNT, g_eightchannel_data_map_activations);
  
  const ai_buffer_array map_weights = 
    AI_BUFFER_ARRAY_OBJ_INIT(AI_FLAG_NONE, AI_EIGHTCHANNEL_DATA_WEIGHTS_COUNT, g_eightchannel_data_map_weights);
