/**
  ...
  ******************************************************************************
  */
#ifndef AI_EIGHTCHANNEL_H
#define AI_EIGHTCHANNEL_H

#include "eightchannel_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_EIGHTCHANNEL_MODEL_NAME          "eightchannel"
#define AI_EIGHTCHANNEL_ORIGIN_MODEL_NAME   "model_quant_int8002"

/******************************************************************************/
#define AI_EIGHTCHANNEL_ACTIVATIONS_ALIGNMENT   (4)
#define AI_EIGHTCHANNEL_INPUTS_IN_ACTIVATIONS   (4)
#define AI_EIGHTCHANNEL_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_EIGHTCHANNEL_IN_NUM        (1)

AI_DEPRECATED
#define AI_EIGHTCHANNEL_IN \
  ai_eightchannel_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_EIGHTCHANNEL_IN_SIZE { \
  AI_EIGHTCHANNEL_IN_1_SIZE, \
}
#define AI_EIGHTCHANNEL_IN_SIZE_BYTES { \
  AI_EIGHTCHANNEL_IN_1_SIZE_BYTES, \
}
#define AI_EIGHTCHANNEL_IN_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_EIGHTCHANNEL_IN_1_CHANNEL     (8)
#define AI_EIGHTCHANNEL_IN_1_SIZE        (8)
#define AI_EIGHTCHANNEL_IN_1_SIZE_BYTES  (8)

/******************************************************************************/
#define AI_EIGHTCHANNEL_OUT_NUM       (1)

AI_DEPRECATED
#define AI_EIGHTCHANNEL_OUT \
  ai_eightchannel_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_EIGHTCHANNEL_OUT_SIZE { \
  AI_EIGHTCHANNEL_OUT_1_SIZE, \
}
#define AI_EIGHTCHANNEL_OUT_SIZE_BYTES { \
  AI_EIGHTCHANNEL_OUT_1_SIZE_BYTES, \
}
#define AI_EIGHTCHANNEL_OUT_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_EIGHTCHANNEL_OUT_1_CHANNEL     (7)
#define AI_EIGHTCHANNEL_OUT_1_SIZE        (7)
#define AI_EIGHTCHANNEL_OUT_1_SIZE_BYTES  (7)

/******************************************************************************/
#define AI_EIGHTCHANNEL_N_NODES (4)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup eightchannel
 ...
 * @ref ai_eightchannel_create. Both the activations memory buffer 
 ...
 * using @ref ai_eightchannel_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_eightchannel_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_eightchannel_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_EIGHTCHANNEL_*
 * defines into file @ref eightchannel.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_eightchannel_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_EIGHTCHANNEL_H */
