/**
  ...
  ******************************************************************************
  */
#ifndef AI_EIGHT_CHANNEL_H
#define AI_EIGHT_CHANNEL_H

#include "eight_channel_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_EIGHT_CHANNEL_MODEL_NAME          "eight_channel"
#define AI_EIGHT_CHANNEL_ORIGIN_MODEL_NAME   "model_quant_int8"

/******************************************************************************/
#define AI_EIGHT_CHANNEL_ACTIVATIONS_ALIGNMENT   (4)
#define AI_EIGHT_CHANNEL_INPUTS_IN_ACTIVATIONS   (4)
#define AI_EIGHT_CHANNEL_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_EIGHT_CHANNEL_IN_NUM        (1)

AI_DEPRECATED
#define AI_EIGHT_CHANNEL_IN \
  ai_eight_channel_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_EIGHT_CHANNEL_IN_SIZE { \
  AI_EIGHT_CHANNEL_IN_1_SIZE, \
}
#define AI_EIGHT_CHANNEL_IN_SIZE_BYTES { \
  AI_EIGHT_CHANNEL_IN_1_SIZE_BYTES, \
}
#define AI_EIGHT_CHANNEL_IN_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_EIGHT_CHANNEL_IN_1_CHANNEL     (9)
#define AI_EIGHT_CHANNEL_IN_1_SIZE        (9)
#define AI_EIGHT_CHANNEL_IN_1_SIZE_BYTES  (9)

/******************************************************************************/
#define AI_EIGHT_CHANNEL_OUT_NUM       (1)

AI_DEPRECATED
#define AI_EIGHT_CHANNEL_OUT \
  ai_eight_channel_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_EIGHT_CHANNEL_OUT_SIZE { \
  AI_EIGHT_CHANNEL_OUT_1_SIZE, \
}
#define AI_EIGHT_CHANNEL_OUT_SIZE_BYTES { \
  AI_EIGHT_CHANNEL_OUT_1_SIZE_BYTES, \
}
#define AI_EIGHT_CHANNEL_OUT_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_EIGHT_CHANNEL_OUT_1_CHANNEL     (8)
#define AI_EIGHT_CHANNEL_OUT_1_SIZE        (8)
#define AI_EIGHT_CHANNEL_OUT_1_SIZE_BYTES  (8)

/******************************************************************************/
#define AI_EIGHT_CHANNEL_N_NODES (4)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup eight_channel
 ...
 * @ref ai_eight_channel_create. Both the activations memory buffer 
 ...
 * using @ref ai_eight_channel_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_eight_channel_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_eight_channel_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_EIGHT_CHANNEL_*
 * defines into file @ref eight_channel.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_eight_channel_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_EIGHT_CHANNEL_H */
