...
uint8_t TxData_temp[8] = {x00, 0x00, 0x19, 0x00, 0x00, 0x00, 0x00, 0x00};
...
uint8_t TxData_cell_temp[8] = {0x03, 0x70, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
